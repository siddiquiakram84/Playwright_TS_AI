...
export class HomePage extends BasePage {
  ...
  async isLoggedIn(): Promise<boolean> { return this.loggedInUser.isVisible(); }
  ...
  async goToLogin(): Promise<void>    { await this.navLogin.click(); }
  async goToSignup(): Promise<void>   { await this.navSignup.click(); }
  async goToCart(): Promise<void>     { await this.navCart.click(); }
  async goToProducts(): Promise<void> { await this.navProducts.click(); }
  async logout(): Promise<void>       { await this.navLogout.click(); }
}
